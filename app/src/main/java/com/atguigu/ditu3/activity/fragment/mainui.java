...
public class mainui extends RelativeLayout {
    ...
    private FrameLayout  commonfrag;
    private FrameLayout  custonmfrag;
    private FrameLayout  otherfrag;
    private FrameLayout  thirdparty;
    ...
    private void initView(Context context) {
        ...
        commonfrag = new FrameLayout(context);
        custonmfrag = new FrameLayout(context);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int tempWidthMeasure = MeasureSpec.makeMeasureSpec(
                (int) (realWidth * 0.83f), MeasureSpec.EXACTLY);
            ...
            switch (ev.getActionMasked()) {
                ...
                case MotionEvent.ACTION_CANCEL:
                    ...
                    if (Math.abs(curScrollX) > leftMenu.getMeasuredWidth() >>> 1) {
                        ...
                        mScroller.startScroll(curScrollX, 0, -curScrollX, 0, 150);
                    }
                    invalidate();
